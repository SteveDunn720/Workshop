...
from Workshop.poly.convert import to_border_edges
...
def faces_to_uv_shell(
    ...
    mesh = faces[0].split(".")[0] if isinstance(faces, list) else faces.split(".")[0]
    ...
    if uv_set:
        ...
        uv_set = get_current_uv_set(mesh=mesh)

    border_edges = to_border_edges(faces)
